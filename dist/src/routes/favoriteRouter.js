...
exports.favoriteRouter.use(auth_1.requireAuth);
exports.favoriteRouter.get('/', favoriteController.list);
exports.favoriteRouter.post('/:listingId', favoriteController.add);
exports.favoriteRouter.delete('/:listingId', favoriteController.remove);
