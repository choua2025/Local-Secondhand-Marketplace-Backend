...
exports.messageRouter.get('/threads', messageController.listThreads);
exports.messageRouter.get('/unread-count', messageController.unreadCount);
exports.messageRouter.get('/', messageController.thread);
exports.messageRouter.post('/', messageController.send);
exports.messageRouter.post('/read', messageController.markRead);
